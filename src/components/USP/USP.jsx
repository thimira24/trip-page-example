            ...
            <div className="usp-container">
                <div className="usp-item">
                    <div className="usp-icon-wrapper">
                        <img src={`${import.meta.env.BASE_URL}icons/local guides.png`} alt="Local guides" className="usp-image" />
                    </div>
                ...
                <div className="usp-item">
                    <div className="usp-icon-wrapper">
                        <img src={`${import.meta.env.BASE_URL}icons/small.png`} alt="Small groups" className="usp-image" />
                    </div>
                ...
                <div className="usp-item">
                    <div className="usp-icon-wrapper">
                        <img src={`${import.meta.env.BASE_URL}icons/off.png`} alt="Off the beaten path" className="usp-image" />
                    </div>
